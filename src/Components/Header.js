  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/">
          <p
          className="bg-clip-text bg-gradient text-black fond-bold md:text-2xl xl:text-3xl xl:leading-tight font-bold"
        >iamCMC</p>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          <li className="pb-1 md:pb-0">
            <NavLink className="bg-clip-text bg-gradient text-black fond-medium font-bold text-lg" to="/" onClick={toggleClass}>
              Home
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink className="bg-clip-text bg-gradient text-black fond-medium font-bold text-lg" to="/about" onClick={toggleClass}>
              About
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink className="bg-clip-text bg-gradient text-black fond-medium font-bold text-lg" to="/technologies" onClick={toggleClass}>
              Technologies
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink className="bg-clip-text bg-gradient text-black fond-medium font-bold text-lg" to="/projects" onClick={toggleClass}>
              Projects
            </NavLink>
          </li>
          <li>
            <NavLink className="bg-clip-text bg-gradient text-black fond-medium font-bold text-lg" to="/contact" onClick={toggleClass}>
              Contact
            </NavLink>
          </li>
        </ul>
